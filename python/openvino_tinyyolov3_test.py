...
def main_IE_infer():
    ...
    model_xml = "/home/robot/YOLO/tiny_yolo/frozen_darknet_yolov3_model.xml"
    model_bin = "/home/robot/YOLO/tiny_yolo/frozen_darknet_yolov3_model.bin"
    ...
    while cap.isOpened():
        ...
        for output in outputs.values():
            objects = ParseYOLOV3Output(output, new_h, new_w, camera_height, camera_width, 0.3, objects)
